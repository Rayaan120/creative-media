...
,
  ...
  const milestones = [
  {
    ...
    description: "Launched with a vision to deliver exceptional creative and event solutions."
  },
  {
    year: "2008",
    event: "Expanded into Movie Production",
    description: "Ventured into film production, adding cinematic storytelling to our offerings."
  },
  {
    year: "Present",
  ...
  >
    <h1 className="text-6xl md:text-7xl font-bold text-white mb-8">
      About <span className="gradient-text">Media Factory</span>
    </h1>
    <p className="text-2xl text-gray-300 max-w-5xl mx-auto leading-relaxed">
      We are a premier creative production house dedicated to transforming ideas into compelling visual experiences. 
            With over a decade of industry expertise, we've established ourselves as leaders in multimedia production and digital innovation.
    </p>
  </motion.div>
</section>
    ...
    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10 justify-items-center">
      {team.map((member, index) => (
        <motion.div
          ...
          transition={{ duration: 0.6, delay: index * 0.1 }}
          viewport={{ once: true }}
          className="glass rounded-3xl overflow-hidden hover:bg-gray-700/50 transition-all duration-500 group hover:scale-105 hover:shadow-2xl"
        >
          {/* Image */}
